...
function OtherCharacter({ myCharactersData, loadCharacter, updateAllCharactersData, webrtcSocket }) {
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            remove(myCharacterRef)
                .then(function(){
                    console.log("OtherCharacter remove succeeded.");
                })
                .catch(function(error){
                    console.log("OtherCharacter remove failed: " + error.message);
                });
        }
    }, [webrtcSocket]);
